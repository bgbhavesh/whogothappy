...
(function (root, factory) {
  ...
  */
  ...
  function _showElement(targetElement) {
    if(targetElement.scriptElement)
      targetElement.element = targetElement.scriptElement();
    else
      targetElement.element = $(targetElement.selector)[0];

    targetElement.self = this;

    if(targetElement.scriptCondition){
      targetElement.scriptCondition(this._currentStep);
    }
