...
module.exports = function( ss_key, auth_id ){
  ...
  this.addWorkSheet = function(){
      var data = '<entry xmlns="http://www.w3.org/2005/Atom" xmlns:gs="http://schemas.google.com/spreadsheets/2006"><title>' +Math.random() +'</title><gs:rowCount>50</gs:rowCount><gs:colCount>10</gs:colCount></entry>';
