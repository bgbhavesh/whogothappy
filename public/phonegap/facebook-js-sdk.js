...
FB.provide('UIServer', {
    ...
    prepareCall: function (params, cb) {
        ...
        if (!(call.id in FB.UIServer._defaultCb) && !('next' in call.params) && !('redirect_uri' in call.params)) {
    ...
    getDisplayMode: function (method, params) {
        ...
        if (!FB.getAccessToken() &&
            params.display == 'dialog' && !method.loggedOutIframe) {
...
FB.subclass('XFBML.IframeWidget', 'XFBML.Element', null, {
    ...
    process: function (force) {
        ...
        this.loaded = false;
        this.subscribe(
            'iframe.onload', FB.bind(function () {
                this.loaded = true;
            }, this));
    },
    ...
    _oneTimeSetup: function () {
        ...
        if (FB.getLoginStatus) {
            this.subscribe(
                ...
                FB.bind(FB.getLoginStatus, FB, function () {
                }, true));
            this.subscribe(
                'xd.logout',
...
FB.subclass('XFBML.EdgeWidget', 'XFBML.IframeWidget', null, {
    ...
    _getWidgetWidth: function () {
        ...
        var layoutToDefaultWidthMap =
        {
            ...
            'box_count': {
                'show': box_count_default_width,
                'hide': box_count_default_width
            },
            'button_count': {
                'show': button_count_default_width,
                'hide': button_count_default_width
            },
            'simple': {
                'show': simple_default_width,
        ...
        var allowedWidths =
        {
            ...
            'box_count': {
                'min': box_count_default_width,
                'max': 900
            },
            'button_count': {
                'min': button_count_default_width,
                'max': 900
            },
            'simple': {
                'min': 49,
